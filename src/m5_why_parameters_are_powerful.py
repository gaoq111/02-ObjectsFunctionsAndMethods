...
def main():
    ...
    """
    drawing_speed = 6 # Bigger numbers mean faster drawing
    ...
    better_draw_circles(rg.Point(200,-100),3)
    better_draw_circles(rg.Point(0,180),60)
    even_better_draw_circles(rg.Point(50,50),20,10,'green',20)
    even_better_draw_circles(rg.Point(100,100),10,3,'red',5)
    window.update()
